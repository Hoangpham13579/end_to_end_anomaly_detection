...
# If True, use non-local
_C.MODEL.NON_LOCAL = True

# Non-local parameters
_C.MODEL.NUM_BLOCK_TEMP_KERNEL = [3, 4, 6, 3]

# Demo weights
_C.MODEL.WEIGHT = ''

# Warmup
_C.MODEL.WARMUP = True
...
# # Path to features's folder
# _C.DATA.PATH_TO_FEATURE = ""
...
# Path to input video for demo_data.
_C.DEMO.INPUT_VIDEO = ""
...
# Input format from demo_data video reader ("RGB" or "BGR").
...
# This is used for fast demo_data speed by reducing the prediction/visualiztion frequency.
...
# Anomaly score threshold for demo_data.
_C.DEMO.ANOMALY_THRESHOLD = 0.5

# Batch size clips for video demo
_C.DEMO.BATCH_SIZE = 1
