...
class FeatureExtractor:
    ...
    def __init__(self, cfg, gpu_id=None):
        ...
        # # Build Torch_TensorRT feature extractor model and load checkpoint.
        # logger.info("Start loading Feature Extractor weights.")
        # self.extractor = torch.jit.load(cfg.DATA.FEATURE_EXTRACTOR_CKPT).to(self.gpu_id, non_blocking=True)
        # self.extractor.eval()
...
class AnomalyDetector:
    ...
    def __init__(self, cfg, gpu_id=None):
        ...
        # # RTFM Anomaly Detection Torch_TensorRT model.
        # logger.info("Start loading RTFM weights.")
        # self.rtfm = torch.jit.load(cfg.MODEL.WEIGHT).to(self.gpu_id, non_blocking=True)
        # self.rtfm.eval()
